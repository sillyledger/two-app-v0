  ...
  if (!authChecked || !doc) return (
    <div className="flex-1 flex flex-col min-h-screen min-w-0 overflow-hidden">
      ...
      <main className="flex-1 overflow-y-auto flex flex-col items-center" style={{ paddingTop: '80px' }}>
        <div className="w-full px-16 pt-16 pb-32 max-w-[800px]">
          {/* Title */}
    ...
    >
      <>
        ...
        >
          ...
          <main className="flex-1 overflow-y-auto flex flex-col items-center" style={{ paddingTop: '80px' }}>
            <div className={`w-full px-16 pt-16 pb-32 transition-all duration-200 ${wideMode ? 'max-w-[1200px]' : 'max-w-[800px]'}`}>
              <textarea
                ref={titleRef}
                value={title}
