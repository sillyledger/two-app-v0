  ...
  try {
    const entries = await sql`
      SELECT
        ...
        'doc' AS type,
        docs.title AS title,
        docs.updated_at::timestamptz AS updated_at,
        docs.created_at::timestamptz AS created_at,
      ...
      SELECT
        ...
        notes.updated_at::timestamptz AS updated_at,
        notes.created_at::timestamptz AS created_at,
